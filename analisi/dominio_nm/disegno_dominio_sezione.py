"""
disegno_dominio_sezione.py  –  analisi/dominio_nm/
====================================================
Widget OpenGL 2D per la visualizzazione della geometria della sezione
nel pannello Dominio N-M (anteprima sezione selezionata dalla combobox).

Identico per funzionalità al widget pressoflessione; specializzato qui
per evitare dipendenze incrociate tra i due moduli.
...
class DominioSezioneWidget(QOpenGLWidget):
    """
    Widget OpenGL per la visualizzazione della geometria della sezione
    nel pannello Dominio N-M (anteprima).
    """
    ...
    def __init__(self, parent=None) -> None:
        ...
        # Dati sezione correnti (per ripristinare il fit su reset_view)
    ...
    def set_section_data(self, section_data: dict | None) -> None:
        ...
        Parametri
        ---------
        section_data : dict con chiave 'elementi' (formato progetto SectionCHECK).
