...
class Acciaio_Profili:
    ...
    def __init__(self, ui):
        ...
        self.ui.btn_acciaioprofili_aggiungi.clicked.connect(self.aggiungi_riga_acciaioprofili)
        self.ui.btn_acciaioprofili_rimuovi.clicked.connect(self.rimuovi_riga_acciaioprofili)
    ...
    def aggiungi_riga_acciaioprofili(self):
        ...
        # Aggiungi ai layout
        self.ui.layout_acciaioprofili_sigma.addWidget(nuovo_sigma)
        self.ui.layout_acciaioprofili_epsilon_min.addWidget(nuovo_eps_min)
        self.ui.layout_acciaioprofili_epsilon_max.addWidget(nuovo_eps_max)
    ...
    def rimuovi_riga_acciaioprofili(self):
        if self.contatore_righe > 0:
            ...
            self.ui.layout_acciaioprofili_sigma.removeWidget(ultimo_sigma)
            self.ui.layout_acciaioprofili_epsilon_min.removeWidget(ultimo_eps_min)
            self.ui.layout_acciaioprofili_epsilon_max.removeWidget(ultimo_eps_max)
    ...
    def generatore_matrice_acciaioprofili(self):
        ...
        valori_iniziali = [
            ((self.ui.acciaioprofili_sigma_1.text() or 0),
            float(self.ui.acciaioprofili_epsilon_min_1.text() or 0),
            float(self.ui.acciaioprofili_epsilon_max_1.text() or 0)),

            ((self.ui.acciaioprofili_sigma_2.text() or 0),
            float(self.ui.acciaioprofili_epsilon_min_2.text() or 0),
            float(self.ui.acciaioprofili_epsilon_max_2.text() or 0)),

            ((self.ui.acciaioprofili_sigma_3.text() or 0),
            float(self.ui.acciaioprofili_epsilon_min_3.text() or 0),
            float(self.ui.acciaioprofili_epsilon_max_3.text() or 0)
            )
        ]
