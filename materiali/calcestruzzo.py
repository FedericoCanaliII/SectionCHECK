...
class Calcestruzzo:
    ...
    def get_dati(self):
        ...
        fissi = [
            [self.ui.calcestruzzo_sigma_1.text(),
             self.ui.calcestruzzo_epsilon_min_1.text(),
             self.ui.calcestruzzo_epsilon_max_1.text()],
            [self.ui.calcestruzzo_sigma_2.text(),
             self.ui.calcestruzzo_epsilon_min_2.text(),
             self.ui.calcestruzzo_epsilon_max_2.text()],
        ]
        dinamici = [
    ...
    def carica_dati(self, dati):
        ...
        coppie_fissi = [
            ('calcestruzzo_sigma_1', 'calcestruzzo_epsilon_min_1', 'calcestruzzo_epsilon_max_1'),
            ('calcestruzzo_sigma_2', 'calcestruzzo_epsilon_min_2', 'calcestruzzo_epsilon_max_2'),
        ]
        ...
        while self.contatore_righe > 0:
            self.rimuovi_riga_calcestruzzo()
        # Ricrea righe dinamiche
        for riga in dati.get('dinamici', []):
            self.aggiungi_riga_calcestruzzo()
